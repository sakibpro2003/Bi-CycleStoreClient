  ...
  return (
    <div className="w-11/12 md:mx-auto bg-yellow-50 mb-12 border-2 border-yellow-400 py-12 px-4 md:px-20 text-center shadow-md rounded-2xl mt-10">
      <div className="flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div>
          <button className="bg-yellow-400 hover:bg-yellow-500 text-black font-bold py-3 px-6 rounded-full flex items-center gap-2 shadow-lg transition-all duration-300">
