...
const Products = () => {
  ...
  // Filter products
  let filteredProducts = products.filter((product: TUpdateProduct) =>
  ...
  return (
    <div className="max-w-11/12 mb-12 mx-auto flex flex-col items-center">
      ...
      <div className="w-4/5 lg:w-1/3 flex flex-wrap gap-4 justify-center mb-6">
        ...
        />
        <select value={brand} onChange={(e) => setBrand(e.target.value)} className="select select-warning">
        ...
        <select value={category} onChange={(e) => setCategory(e.target.value)} className="select select-warning">
          <option value="">All Categories</option>
          <option value="Mountain">Mountain</option>
          <option value="Road">Road</option>
          <option value="Hybrid">Hybrid</option>
        </select>
        <select value={availability} onChange={(e) => setAvailability(e.target.value)} className="select select-warning">
          <option value="">Availability</option>
          <option value="In Stock">In Stock</option>
          <option value="Out of Stock">Out of Stock</option>
        </select>
        <select value={sortOrder} onChange={(e) => setSortOrder(e.target.value)} className="select select-warning">
